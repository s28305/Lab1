...
Original file is located at
    https://colab.research.google.com/drive/13oYOocHU3YxkS4Abd1YgePHkePNZaiJu
...
classWork = float(input("Enter score for work in class: "))
test = float(input("Enter score for the test: "))
project = float(input("Enter score for the project: "))

score = 0.2*classWork + 0.3*test + 0.5*project
if score >= 85:
    grade = 5
elif score >= 70:
    grade = 4
...
if n1 % n2 == 0:
    print(n1, "can be divided by", n2)
else:
    print(n1, "cannot be divided by", n2)
...
exists = (side1 < (side2 + side3)) & (side2 < (side1 + side3)) & (side3 < (side2 + side1))

if exists == 0:
  print("The triangle does not exists with sides: ", side1, side2, side3)
else:
  if side1 == side2 == side3:
      triangle_type = "Equilateral"
  elif side1 == side2 or side1 == side3 or side2 == side3:
